...
def predict_year_point_to_geojson(input_csv, year, output_dir):
    ...
    # smoothed = line_gdf.simplify(tolerance=1000, preserve_topology=False)

    # === Save both point and line outputs ===
    os.makedirs(os.path.dirname(output_dir), exist_ok=True)
    # point_path = os.path.join(output_dir, f"predicted_shoreline_{year}_points.geojson")
    # line_path = os.path.join(output_dir, f"predicted_shoreline_{year}_line.geojson")
